    ...
    <nav class="navbar navbar-expand-md navbar-light bg-body border-bottom p-0 ps-5" id="navbarz">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" id="profile_drop">
                <li><a class="dropdown-item" href="a_dashboard.php?dashboard" name="dashboard">Dashboard</a></li>
                <li><a class="dropdown-item" href="logout.php?logout" name="logout">Logout</a></li>
            </ul>
        </div>
    </nav>
                    ...
                    <div class="list-group list-group-flush mx-3 mt-4">
                        ...
                        <div class="btn-group dropend ">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item bg-danger text-white" href="a_user_logs.php?userlogs">User Logs</a></li>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="transform: rotate(0);" class="">
                                <td scope="row" style="width: 0%"><?php echo $item['aid'] ?></td>
                                <td scope="row"><?php echo $item['fname'] . ' ' . $item['lname'] ?></td>
                                <td scope="row"><?php echo $item['role'] ?></td>
                                <td scope="row"><?php echo $item['action'] ?></td>
                                <td scope="row" style="width: 25%"><?php echo $date . ' • ' . $time ?></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
