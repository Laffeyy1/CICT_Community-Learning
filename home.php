    ...
    <nav class="navbar navbar-expand-md navbar-light bg-body border-bottom p-0 ps-5" id="navbarz">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" id="profile_drop">
                <li><a class="dropdown-item" href="profile.php?profile">Profile</a></li>
                        ...
                        <div class="bg-white border-gray mt-4" >
                            ...
                            <div class="post-footer p-2" id="post">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <form method="post">
                                        <button type="submit" name="comm" id="foot_btnc" class="left-button post-button bg-white border-0 text-black">
                                            <input type="hidden" value="<?php $item['form_id'] ?>" name="formid">
                                            <i class="bi bi-chat-square fa-lg ms-5"></i>
                                            <a class="text-decoration-none text-black">Comment</a>
                                        </button>
                                    </form>
                                </div>
                            </div>
